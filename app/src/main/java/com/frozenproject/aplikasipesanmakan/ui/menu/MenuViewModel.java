...
import com.frozenproject.aplikasipesanmakan.callback.ICategoryCallbackListener;
...
public class MenuViewModel extends ViewModel implements ICategoryCallbackListener {
    ...
    private void loadCategories() {
        ...
        DatabaseReference categoryRef = FirebaseDatabase.getInstance().getReference(Common.CATEGORY);
